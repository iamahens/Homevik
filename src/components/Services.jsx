...
const Services = () => {
    ...
    const services = [
        { icon: 'security', title: 'Security Systems', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', image: 'https://images.unsplash.com/photo-1596720186288-13a85f40f0c7?q=80&w=2070&auto=format&fit=crop', isHighlighted: true },
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="lg:col-span-1 text-center lg:text-left">
                         <div className={`transition-all duration-700 ease-in-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{ transitionDelay: '0.2s' }}>
